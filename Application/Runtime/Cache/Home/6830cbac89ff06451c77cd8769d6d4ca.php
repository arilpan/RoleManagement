	...
	<div class="admin-content-body">
		<div class="am-cf am-padding am-padding-bottom-0">
			<div class="am-fl am-cf">
				<strong class="am-text-primary am-text-lg">用户管理</strong> / <small>user
					manager</small>
			</div>
		</div>
		...
		<div class="am-tabs am-margin" data-am-tabs>
			<ul class="am-tabs-nav am-nav am-nav-tabs">
				<li class="am-active"><a href="#tab1">增加用户</a></li>
				
				<!--
					<li><a href="#tab2">查询用户</a></li> 
        			<li><a href="#tab3">编辑用户</a></li> 
        		-->
				<li><a href="#tab2">用户列表</a></li>
			</ul>

			<div class="am-tabs-bd">
				<div class="am-tab-panel am-fade am-in am-active" id="tab1">
					<form class="am-form" action="/flow_manger/Home/User/add"
						method="post">
						...
						<div class="am-g am-margin-top-sm">
							<div class="am-u-sm-4 am-u-md-2 am-text-right">用户推荐人id</div>
							<div class="am-u-sm-8 am-u-md-4 am-u-end">
								<input type="text" class="am-input-sm" name="referee_id">
							</div>
						</div>
							...
							<table
								...
								<thead>
									<tr>
										...
										<th class="table-author am-hide-sm-only">用户昵称</th>
										<th class="table-author am-hide-sm-only">用户推荐人</th>
								...
								<tbody>
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td class="am-hide-sm-only"><?php echo ($vo["password"]); ?></td>
										<td><?php echo ($vo["nickname"]); ?></td>
										<td class="am-hide-sm-only"><?php echo ($vo["referee_id"]); ?></td>
											...
											<div class="am-btn-toolbar">
												<div class="am-btn-group am-btn-group-xs">
													<button
														...
														<a href="/flow_manger/Home/User/edit/id/<?php echo ($vo["id"]); ?>">
													...
													<button
														...
														<a href="/flow_manger/Home/User/delete/id/<?php echo ($vo["id"]); ?>">
